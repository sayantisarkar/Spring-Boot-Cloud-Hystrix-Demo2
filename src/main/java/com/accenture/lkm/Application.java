...
public class Application {
    ...
    // Out of 5 requests sent 2 are failing. 
    ...
    // within 6 seconds for just 5 calls out which 30% are failing.
    // i.e. just for 2 failed calls with in 6 seconds circuit will trip open.
    public static void testMethod2(MyService myService) throws Exception{
    	 System.out.println("\n\n-- Executing: compute() 5 times --");
         int num = 0;
